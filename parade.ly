...
right = << \global \relative {
  \clef treble
  a'8 fis' e d e a fis e | d[ e d b] a b[ b16 b] b8[ cis] |
  \override TextSpanner.bound-details.left.text = "riten."
  <fis, d'>\startTextSpan <fis cis'> <g d'> <a e'>\stopTextSpan |
  ...
  << \context Voice = "2" {
    ...
    \t { q4 \cleft \voiceOne a8 b4 d8 e4 d8 e4 d8 } | \cright \oneVoice <fis, a fis'>4 \t { <d' a'>4 <a d>8 a' g fis e d b }
  } \new Voice {
  ...
  r2 <a a'>8 r \t { r4 g'8 ~ | g4 fis8 e4 a8 } d,4 \t { a,8 b cis } \break |
  ...
  \repeat volta 2 {
    << {
      ...
      <a cis>8 s a r cis s <a cis> r | <ais cis e> r \t { q8[ r e'] } <cis e>8 s <ais cis> r |
    } >>
    ...
    \t { q4 \cright \oneVoice d'8 e fis a } << { d8 r r4 } \\ { d,4 e } >>

    << {
      \t { f4 e8 f4 e8 } f4 \t { e4 f8 ~ | f4 e8 f4 e8 } f4 \t { e'4 f8 ~ } |
      \t { f4 e8 f4 e8 } f4
       } \\ {
      <a,, c>2. \t { q4 <g c>8 ~ } | q2. \t { <g' c>4 <a c>8 ~ } |
      q2.
    } >> \t { <a c e g>4 <c f a>8 ~ q4 <c e g>8 } q4-_ \t { <g c e g>4 <f bes d f>8 ~ q4 <e a cis e>8 ~ }

    q2 r2 | r4 \t { r8 e e' } e8 r \ottava 1 \t { e8 e'4 } \ottava 0 |
    \t { <e,, gis b e>4 q8 <fis b d fis>4 q8 } <gis b e gis>4 << { \t { \oneVoice <b e b'>4 \voiceOne a'8 ~ } | a4 r } \\ { \ti { s4 <a, d e>8 ~ } \t { q4 q8 } q4-_ } >>
  ...
  \alternative {
    { \t {g4 fis8 e4 a8 } d,4 \t { a,8 b cis } | }
    { \t {g''4\repeatTie fis8 e4 a8 } d,4 r4 | }
  }
  ...
  << {
    ...
    \oneVoice \t { q4 <a a'>8 <g' e' g>4 <f d' f>8 ~ } q4 \voiceOne \tuplet 6/4 { a'16 g f e d c } |
     } \\ {
  ...
  \t { <\parenthesize d f d'>8 <\parenthesize e g e'> <\parenthesize d f d'> <\parenthesize e g e'> <\parenthesize d f d'> <\parenthesize e g e'> }
  <\parenthesize d f d'>4 \t { r8 g, bes } |
  ...
  r2 <a a'>8 r \t { r4 g'8 ~ | g4 fis8 e4 a8 d, fis a } <d, fis d'>8 r |
} >>
...
left = << \global \relative {
  ...
  \voiceFour \t { q4 d'8 } \hs 0.3 fis4 \t { fis,4 d'8 \hs 0.3 g a d, } | \oneVoice \t { <g, g'>4 g'8 } g4 \t { g,4 d'8 g,[ g'] <a, a'> ~ }
  ...
  \t { r4 d8 d'[ r d'] <a, a'>[ r a'] \handBracket ##f -1 \parenthesize a' r <g,, g'> ~ | q4 <fis fis'>8 <e e'>4 <a a'>8 } <d, d'>4 r |
  ...
  \alternative {
    { \t { q4 <fis fis'>8 <e e'>4 <a a'>8 } <d, d'>4 r | }
    { \t { <g g'>4\repeatTie <fis fis'>8 <e e'>4 <a a'>8 } <d, d'>4 r | }
  }
  ...
  << {
    \voiceOne \t { bes4 d8 f4 a,8 ~ a4 c8 f4 a,8 ~ a4 g'8 ~ g4 d8 ~ } d4 \t { d4 f8 } |
    \oneVoice <g, g'>4 \t { g4 g,8 ~ g4 g'8 ~  g4 <a, a'>8 ~ } |
      } \new Voice {
    \voiceTwo bes4 \ti { bes'4 c,8 ~ } c4 \ti { c'4 a,8 ~ | a4 a'8 ~ a4 d,8 ~ } d4 d |
  } \new Voice { \hideNotes \showStaffSwitch \override NoteColumn.ignore-collision = ##t s1 | s2. \ti { r4 f'8 | \cright a4 } } >>
  \t { q4 a,,8 ~ a4 a'8 ~ a4 a,8 } a'4 |

  \t { <bes bes'>8 q q } q8 r \t { <bes, bes'>8 q q } q8 r | \t { q8 q q q q q } q4 \t { r8 bes' bes' } |
  ...
  <b b'>4-_ q-_ <bes bes'>-_ q-_ | <a a'>-_ q <gis gis'>-_ q-_ |
  <e e'>4 <fis fis'> <g g'> \t { gis'8[ gis,] <a a'> ~ q4 e'8 } a,4 \t { <a a'>4 <ais ais'>8 r4 <b b'>8 ~ }
  ...
  \t { r4 d8 d'[ r d'] <a, a'>[ r a'] \handBracket ##f -1 \parenthesize a' r <g,, g'> ~ | q4 <fis fis'>8 <e e'>4 <a a'>8 <d, d'> fis a } d8 r |
} >>
